...
const tableName = "seascape_table";
...
app.get('/api/imgs/:date', (req, res) => {
    ...
    const sql = 'SELECT * FROM seascape_table WHERE image_date >= ? AND image_date < ?';
...
app.post('/api/annot', (req, res) => {
    ...
    const sql = `UPDATE ${tableName} SET ml_user_labels="${req.body.class}" WHERE image_id=?`
